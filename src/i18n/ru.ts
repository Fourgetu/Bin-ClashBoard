...
const ru: LANG_MESSAGE = {
  ...
  useServerProxyTip:
    'Сервер Bin-ClashBoard сам обращается к Mihomo/OpenClash, поэтому панели не нужен прямой публичный доступ к контроллеру.',
  ...
  restartProxyFailed: 'Не удалось перезапустить прокси. Проверьте SSH и состояние службы OpenWrt.',
