...
const zh: LANG_MESSAGE = {
  ...
  useServerProxyTip:
    '由 Bin-ClashBoard 后端代连 Mihomo/OpenClash，公网访问面板时无需再直连控制器。',
  ...
  restartProxyInProgress: '正在重启代理…',
  restartProxyRefreshing: '代理已重启，正在刷新规则和节点…',
  restartProxySuccess: '代理重启成功',
  restartProxyFailed: '代理重启失败，请检查 OpenWrt SSH 和服务状态',
  ruleType: '规则类型',
  ip: 'IP',
